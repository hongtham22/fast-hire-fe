...
const JobKeyword: React.FC<JobKeywordProps> = ({ keywords }) => {
  ...
  return (
    <div className="w-1/2 mt-8 bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
      <h2 className="text-2xl font-semibold mb-4 text-emerald-500 border-b pb-2">Job Requirements</h2>
      
      <div className="space-y-6">
        {/* Role and Experience */}
        <div className="bg-gray-50 p-4 rounded-lg">
          <h4 className="font-semibold text-lg text-emerald-500 mb-3 border-b border-gray-200 pb-1">Basic Requirements</h4>
        ...
        {keywords.key_responsibilities && keywords.key_responsibilities.length > 0 && (
          <div className="bg-gray-50 p-4 rounded-lg">
            <h4 className="font-semibold text-lg text-emerald-500 mb-3 border-b border-gray-200 pb-1">Key Responsibilities</h4>
